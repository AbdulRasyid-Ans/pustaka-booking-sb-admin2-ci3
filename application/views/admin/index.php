                ...
                <div class="container-fluid">
                    <!-- row ux-->
                    <div class="container-fluid">
                        <div class="col-xl-3 ccol-md-6 mb-4">
                            <div class="card border-left-danger shadow h-100 py-2 bg-primary">
                                <div class="card-body">
                                    <div class="row no-gutters allign-items-center">
                                        <div class="col mr-2">
                                            <div class="text-md font-weight-bold text-whote text-uppercase mb-1">Jumlah Anggota</div>
                        ...
                        <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2">
                            <div class="page-header">
                                ...
                                <a class="text-danger" href="<?php echo
                                    base_url('user/data_user'); ?>"><i class="fas fa-search mt-2 float-right"> Tampilkan</i>
                                </a>
                            </div>
